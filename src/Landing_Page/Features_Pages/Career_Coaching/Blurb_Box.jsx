            ...
            <div className = "container">
                <div className = "row">
                    <div className = "col-lg-3 div-under-img">
                        ...
                        Work with a professional coach to take your career to the next level.
                        </h5>
                    </div>
                    <div className = "col-lg-7 div-under-img-right">
                        ...
                        In fact, the data is clear that a career coach can help take your career to new levels.</p>
                    </div>
                </div>
            </div>
        </div>
