            ...
            <div className = "container">
                <div className = "row">
                    <div className = "col-lg-3 div-under-img">
                        ...
                        Cover letters are a perfect opportunity to distinguish yourself as a candidate.
                        </h5>
                    </div>
                    <div className = "col-lg-7 div-under-img-right">
                        ...
                        what makes you uniquely qualified (outside of what is on your resume), while providing an opportunity 
                        to demonstrate passion for the company and position for which you’re applying. It can also be the perfect place to address any 
                        potential questions or concerns in your resume, such as extended gaps in employment or unusual circumstances.</p>
                    </div>
                </div>
            </div>
        </div>
