    ...
    return (
                ...
                <div className = "row">
                    <div className = "col-lg-3 div-under-img">
                        <h5 className = "under-img-text-left">
                            Recruiters rank professionally written resumes 60% 
                            higher than those written by job seekers alone. (source: Forbes)
                        </h5>
                    </div>
        <div className = "col-lg-7 div-under-img-right">
            <p className = "div-under-img-right-text"><h4 class="font-weight-bold">A well-written, professional resume is an absolute must in today’s competitive job market.</h4>
                ...
                professional feedback or don’t have a resume and need someone to write one from scratch, 
                ResumeSpice can help. Below are the various resume options we offer. 
