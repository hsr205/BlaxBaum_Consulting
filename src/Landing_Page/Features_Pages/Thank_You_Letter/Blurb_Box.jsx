    ...
    return (
                ...
                <div className = "row">
                    <div className = "col-lg-3 div-under-img">
                        <h5 className = "under-img-text-left">
                            In a recent CareerBuilder study, 86% of hiring managers said 
                            not sending a thank you note demonstrated a lack of follow-through.
                        </h5>
                    </div>
        <div className = "col-lg-7 div-under-img-right">
            <p className = "div-under-img-right-text"><h4 class="font-weight-bold">Following-up after an interview with a well-crafted thank you letter can provide a crucial edge in your job search.</h4>
                ...
                and 56 percent said not doing so showed the candidate was not serious about the position. </p>
            </div>
        </div>
    </div>
</div>
